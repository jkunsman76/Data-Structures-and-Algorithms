...
// Selection Sort with sort sort the Array from lowest to highest.
// will work with highest to lowest, but it is best practice to sort from lowest to highest.
// will work with the alphabet as well

//  speed test aka time complexity result = O(n*n)
